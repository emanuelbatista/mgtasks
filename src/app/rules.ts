...
export let defineRules = (angularm: AngularmService) => {
    angularm
        ...
        .etr('list_entities','project',ListingTableComponent,{centerTh: true} )
        .etr('list_entities','bug',ListingTableComponent,{centerTh: true} )
        .etr('list_entities','issue',ListingTableComponent,{centerTh: true} )
        .etr('list_entities','product',ListingTableComponent,{centerTh: true} )
        .der('table_line', EntityLineComponent)
        .er('table_line', 'project',EntityLineComponent, {centerTd: true})
        .er('table_line', 'bug',EntityLineComponent, {centerTd: true})
        .er('table_line', 'issue',EntityLineComponent, {centerTd: true})
        .er('table_line', 'product',EntityLineComponent, {centerTd: true})
